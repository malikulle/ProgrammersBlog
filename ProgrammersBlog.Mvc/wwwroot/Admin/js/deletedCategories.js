        ...
        buttons: [
            {
                ...
                action: function (e, dt, node, config) {
                    $.ajax({
                        type: 'GET',
                        url: '/Admin/Categories/GetAllDeletedCategories/',
    ...
    $(document).on('click',
        ...
        function (event) {
            ...
            Swal.fire({
                ...
                text: `${categoryName} adlı kategori silinmekten geri alınacaktır!`,
                icon: 'question',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: { categoryId: id },
                        url: '/Admin/Categories/UndoDelete/',
                        success: function (data) {
                            const undoDletedCategoryResult = jQuery.parseJSON(data);
                            console.log(undoDletedCategoryResult);
                            if (undoDletedCategoryResult.ResultStatus === 0) {
                                Swal.fire(
                                    'Başarılı!',
    ...
    $(document).on('click',
        ...
        function (event) {
            ...
            Swal.fire({
                ...
                text: `${categoryName} adlı kategori silmek İstediğinize Emin Misiniz ?`,
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: { categoryId: id },
                        url: '/Admin/Categories/HardDelete/',
                        success: function (data) {
                            const harDeletedCategoryResult = jQuery.parseJSON(data);
                            console.log(harDeletedCategoryResult);
                            if (harDeletedCategoryResult.ResultStatus === 0) {
                                Swal.fire(
                                    'Başarılı!',
                                    'İşlem Başarılı Bir Şekilde Gerçekleşti',
                                    'success'
